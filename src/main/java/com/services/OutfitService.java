...
public class OutfitService {
    ...
    public Outfit getOutfit(String alias){
        ...
        String outfitResponse = RESTConsumer.get("http://census.daybreakgames.com/" + SERVICE_KEY + "/get/ps2:v2/outfit/?alias_lower=" + alias + "&c:resolve=member_characters_stat_history(stat_name,all_time)&c:join=outfit_member%5Eon:outfit_id%5Einject_at:members%5Elist:1%5Eshow:character_id(characters_online_status%5Eon:character_id%5Einject_at:character%5Eshow:online_status,character%5Eon:character_id%5Einject_at:character%5Eshow:name.first%27times.last_save),characters_world%5Eon:leader_character_id%5Eto:character_id%5Einject_at:leader%5Eshow:world_id,character%5Eon:leader_character_id%5Eto:character_id%5Einject_at:leader%5Eshow:name.first%27faction_id&c:hide=name_lower,alias_lower,time_created_date");
        try {
